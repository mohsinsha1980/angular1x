/**
 * Directive for display 'Angular Proficiency'
 * Creation Date : 11 SEPT 16
 */
  
 'use strict';

 testAngularApp.directive('customTableWidget', function () {
        return {
            restrict: 'EA',
            template: [  
                    ...
                    '<table summary="A table listing various other formats for this product">',
       				...
       				'<td scope="col" class="market_place amount">',
       				'<span>',
       				'<button type="button"><img style="height:20px;width:20px;" src="./img/delete.png" ></button>',
       				'</span>',
       				'</td>',
                    '</tr>',
                    '</tbody>',
