/**
 *  Custom Directive for Populating Table Rows
 *	Created By : 45075 
...
angularApp.directive('tableForListingDirective', function () {
        return {
            restrict: 'EA',
            template: [  
                       '<div ng-controller="MainController as tCtrl" ng-form name="myForm">',
                    ...
                    '<table summary="A table listing various other formats for this product">',
       				...
       				'</thead>',
       				'<tbody>',
                       '<tr class="active" ng-repeat="item in tableList">',
       				...
       				'<span>',
       				'<button type="button" data-ng-click="tCtrl.editRow(item);"><img style="height:20px;width:20px;" src="./imges/edit.png" ></button>',
       				'</span>',
       				'</td>',
       				'<td scope="col" class="market_place amount">',
       				'<span>',
       				'<button type="button"><img style="height:20px;width:20px;" src="./imges/delete.png" ></button>',
       				'</span>',
       				'</td>',
                    '</tr>',
                    '</tbody>',
           ...
           controllerAs:'tCtrl',
            link: function (scope, element, attrs) {
                scope.tableList=scope.$eval(attrs.tableList);
